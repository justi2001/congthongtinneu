  ...
  return (
    <div className="max-w-7xl mx-auto bg-white min-h-screen">
      ...
      <div className="p-6">
        ...
        <table className="bg-white rounded-lg shadow-sm border border-gray-200 w-full">
          {/* Table Header */}
          <thead className="bg-blue-600 text-white">
              <tr>
              <th className="">Mã phí - Tên phí</th>
              <th className="text-center">Hình thức ĐK</th>
              <th className="text-center">Phải đóng</th>
              <th className="text-center">Đã đóng</th>
              <th className="text-center">Căn trừ</th>
              ...
              <th className="text-center">Nội dung thu</th>
              </tr>
          </thead>

          {/* Table Body */}
          <tbody className="divide-y divide-gray-100">
          <tr className="bg-orange-100 rounded-lg p-4 text-center ">
          
          <td className=" text-orange-800 font-semibold p-2">
            Tổng học phí
          </td>
          
          <td className="text-red-600 font-bold p-2"></td>
          <td className="text-red-600 font-bold p-2">
            {formatCurrency(43105650)}
          </td>
          <td className="text-red-600 font-bold p-2">
            {formatCurrency(43105650)}
          </td>
          <td className="text-red-600 font-bold p-2">0</td>
          <td className="text-red-600 font-bold p-2">0</td>
          <td className="text-red-600 font-bold p-2">0</td>
          <td className="text-red-600 font-bold p-2"></td>
          <td className="text-red-600 font-bold p-2"></td>
              ...
              return (
                < >
                  ...
                  {isExpanded && hocKy.monHoc.map((mon, index) => (
                    <tr key={`${semesterKey}-${index}`} className="hover:bg-gray-50">
                      
                        <td className="col-span-3 text-gray-800 p-2">
                          {mon.tenMonHoc}
                        </td>
                        <td className="text-center text-gray-700 p-2">
                  ...
                  {/* Semester Total */}
                  <tr key={`${semesterKey}`}  className="bg-yellow-100 border-b border-yellow-200">
                   
                      <td className="font-semibold text-blue-600 p-2">
                        Tổng học phí: {hocKy.namHoc} - {hocKy.tenHocKy}
                      </td>
                      <td className="text-center font-bold text-blue-600 p-2">
                       
                       </td>
                     
                      <td className="text-center font-bold text-blue-600 p-2">
                        {formatCurrency(hocKy.phaiDong)}
                      </td> 
                      <td className="text-center font-bold text-blue-600 p-2">
                        {formatCurrency(hocKy.daDong)}
                      </td> 
                      <td className="text-center font-bold text-blue-600 p-2">
                        {formatCurrency(hocKy.canTru)}
                      </td>
                      <td className="text-center font-bold text-blue-600 p-2">
                        {formatCurrency(hocKy.mienGiam)}
                      </td>
                      <td className="text-center font-bold text-blue-600 p-2">
                        {formatCurrency(hocKy.conNo)}
                      </td>
                      <td className="text-center font-bold text-blue-600 p-2">
                        {hocKy.ngayDong}
                      </td>
