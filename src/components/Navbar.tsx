  ...
  const menuItems = [
    {
      ...
      items: [
        ...
        { icon: GraduationCap, name: "Thông tin tốt nghiệp", path: "/thong-tin-ca-nhan" },
        { icon: Bell, name: "Thông báo", path: "/thong-bao" },
        { icon: BookOpen, name: "Hướng dẫn sử dụng", path: "https://drive.google.com/file/d/1a7dva-d0ynuiiymvbek9swu_ypdk7foy/view?usp=sharing" }
      ]
    },
    {
    ...
    },
    {
      ...
      items: [
        { icon: Users, name: "Ngoại trú sinh viên", path: "https://drive.google.com/file/d/1a7dva-d0ynuiiymvbek9swu_ypdk7foy/view?usp=sharing" },
        { icon: Edit, name: "Đăng ký học phần", path: "https://drive.google.com/file/d/1a7dva-d0ynuiiymvbek9swu_ypdk7foy/view?usp=sharing" },
        { icon: FileText, name: "Thảo luận học phần", path: "https://drive.google.com/file/d/1a7dva-d0ynuiiymvbek9swu_ypdk7foy/view?usp=sharing" },
        { icon: Calculator, name: "Đánh giá điểm rèn luyện", path: "https://drive.google.com/file/d/1a7dva-d0ynuiiymvbek9swu_ypdk7foy/view?usp=sharing/danh-gia-diem-ren-luyen" },
        { icon: GraduationCap, name: "Đăng ký xét tốt nghiệp", path: "https://drive.google.com/file/d/1a7dva-d0ynuiiymvbek9swu_ypdk7foy/view?usp=sharing" },
        { icon: Settings, name: "Dịch vụ Công Một cửa", path: "https://drive.google.com/file/d/1a7dva-d0ynuiiymvbek9swu_ypdk7foy/view?usp=sharing/dich-vu-cong-mot-cua" },
        { icon: Search, name: "Khảo sát đánh giá", path: "https://drive.google.com/file/d/1a7dva-d0ynuiiymvbek9swu_ypdk7foy/view?usp=sharing" },
        { icon: Archive, name: "Tài liệu số", path: "https://drive.google.com/file/d/1a7dva-d0ynuiiymvbek9swu_ypdk7foy/view?usp=sharing" },
        { icon: Phone, name: "Liên hệ - góp ý", path: "https://drive.google.com/file/d/1a7dva-d0ynuiiymvbek9swu_ypdk7foy/view?usp=sharing" },
        { icon: CreditCard, name: "Nộp chứng chỉ", path: "https://drive.google.com/file/d/1a7dva-d0ynuiiymvbek9swu_ypdk7foy/view?usp=sharing" },
        { icon: Edit, name: "Đăng ký học CTĐT thứ 2", path: "https://drive.google.com/file/d/1a7dva-d0ynuiiymvbek9swu_ypdk7foy/view?usp=sharing/dang-ky-hoc-ctdt-thu-2" },
        { icon: Edit, name: "Đăng ký học vụ", path: "https://drive.google.com/file/d/1a7dva-d0ynuiiymvbek9swu_ypdk7foy/view?usp=sharing" },
        { icon: Edit, name: "Đăng ký dọn hoàn thi - Thi bổ sung học kỳ", path: "https://drive.google.com/file/d/1a7dva-d0ynuiiymvbek9swu_ypdk7foy/view?usp=sharing" },
        { icon: Shield, name: "Đăng ký bảo hiểm y tế", path: "https://drive.google.com/file/d/1a7dva-d0ynuiiymvbek9swu_ypdk7foy/view?usp=sharing" },
        { icon: Edit, name: "Đăng ký thi ghép", path: "https://drive.google.com/file/d/1a7dva-d0ynuiiymvbek9swu_ypdk7foy/view?usp=sharing" }
      ]
    }
  ];

  
  const customPath = menuItems[1].items.map(item=>item.path).concat([`/thong-tin-ca-nhan`,`/thong-tin-ca-nhan`,`/thong-bao`])
          ...
          {menuItems.map((section, sectionIndex) => (
            <div key={sectionIndex} className="mb-1">
              ...
              {section.items.map((item, itemIndex) => {
                ...
                return (
                  <Link href={
                    !customPath.includes(item.path)? item.path:
                    '/me'+item.path} key={itemIndex}>
                    <div
